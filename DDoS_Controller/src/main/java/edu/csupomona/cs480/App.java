...
import edu.csupomona.cs480.data.provider.FSIPManager;
...
public class App {
     ...
     */
	static IPManager ipmRef;
    
    @Bean
    public IPManager ipManager() {
    	IPManager ipManager = new FSIPManager();
    	ipmRef = ipManager;
        return ipManager;
    }
    /**
    ...
    */ 
    ...
    public static void main(String[] args) throws Exception {
        ...
        RefreshCurrentIPList refresh = new RefreshCurrentIPList();
        refresh.start(ipmRef);
    }
}
